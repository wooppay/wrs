...
final class Version20201103094448 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE profile_info (id SERIAL NOT NULL, user_id INT DEFAULT NULL, job_position_id INT DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, surname VARCHAR(255) DEFAULT NULL, gender INT DEFAULT NULL, age INT DEFAULT NULL, github_link VARCHAR(255) DEFAULT NULL, gitlab_link VARCHAR(255) DEFAULT NULL, telegram_link VARCHAR(255) DEFAULT NULL, skype_link VARCHAR(255) DEFAULT NULL, personal_link VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7D41BEC3A76ED395 ON profile_info (user_id)');
        $this->addSql('CREATE INDEX IDX_7D41BEC3BEE8350F ON profile_info (job_position_id)');
